  ...
  render() {
    ...
    return (
      <Grid container spacing={1}>
        <Grid item xs={12} align="center">
          <Collapse in={this.state.errorMsg != "" || this.state.successMsg != ""}>{this.state.successMsg}</Collapse>
        </Grid>
        <Grid item xs={12} align="center">
        ...
        {this.state.update? this.renderUpdateButtons():this.renderCreateButtons()}
      </Grid>
    );
  }
}
